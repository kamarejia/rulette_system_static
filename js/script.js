...
const games = [
    ...
    },
    {
        ...
        details:{
            gameStory:"ファブフィブは3枚のカードでつくった3桁の数字を宣言して隣の人は宣言が嘘か本当かを見破るゲームです。本当だと思ったら3枚のカードをうけとって何枚か交換をおこないます。その後、先の宣言よりも大きな数字を言わなければなりません。もし嘘を見破ったら相手のライフにダメージをあたえます。嘘と駆け引きを駆使して最後まで生き残りましょう。",
            basicInfo:{
                refPrice:"1500円",
                numPlayers:"3~10人",
                playTime:"20~30分",
    ...
    },
    {
        ...
        details:{
            gameStory:"シェフィは1匹のひつじから1000匹のひつじまで増やす一人用カードゲームです。手札のカードの効果を使用してゲームはすすみますが、カードの中にはひつじをただ増やすものだけでなく不幸な事故や自然の脅威がたくさんあります。ひつじを絶やすことなく無事1000ひつじに増やせるでしょうか？",
            basicInfo:{
                refPrice:"1700円",
                numPlayers:"1人",
                playTime:"20分",
                ...
                ageRange:"12歳以上",
                gameSystem:"ハンドマネージメント",
                size:"縦：横：高さ=12.3:14.1:1.9"
            },
            contents:["ルール説明書","カード72枚"],
            credits:{
                designer:["ポーン"],
                artwork:["ポーン"],
                company:["冒険企画局"]
        ...
        qAndA:[
                {
                    "question": "フィールドに1000ひつじではなく300ひつじ3枚と100ひつじ1枚で合計1000匹となっても勝ちですか？",
                    "answer": "勝ちではありません。「統率」をつかって1000ひつじをフィールドにおけたら勝ちです。"
                },
            ],
        likes: {
            count: 3,
    ...
    },
    {
        ...
        details:{
            gameStory:"ザ・マインドは小さい数字からだんだん大きくなるようにみんなで手札の数字を出していく協力ゲームです。ただしプレイヤーは会話やジェスチャー、アクションなどで数字の情報を渡すことは一切できません。そのかわりにみんなの感性を研ぎ澄ませて「間」を駆使して数字を出していきます。小さい数字ならなるべく素早く大きい数字ならゆっくりとだすことでだんだんと感覚が統一されていき最後にはクリアできるでしょう。",
            basicInfo:{
                refPrice:"1500円",
                numPlayers:"2~4人",
                playTime:"20分",
        ...
        qAndA:[
                {
                    "question": "手裏剣カードを使用したあと、どのようにゲームを再開しますか？",
                    "answer": "各自のいちばん小さいカードを捨て札にしてわきに置き、いままでだされていたカードがあればその続きから出していきます。"
                },
            ],
    ...
    },
    {
        ...
        details:{
            gameStory:"お邪魔者はカードを繋げて金鉱を掘っていき金塊を手にいれるカードゲームです。プレイヤーには役割があり勤勉な金鉱堀りとお邪魔者にわかれます。お邪魔者はバレないようにはじめは真面目なフリをしていますがだんだんとさまざまな手段で妨害をしてきます。金鉱堀りは妨害に屈せず金塊を手にいれるために協力して立ち回りましょう。",
            basicInfo:{
                refPrice:"1800円",
                numPlayers:"3~10人",
                playTime:"30分",
        ...
        qAndA:[
                {
                    "question": "破壊カードで同じ種類の道具を2重に破壊することはできますか？",
                    "answer": "同じ種類の道具を2重に破壊することはできません。ただし修理をされたのちに再び破壊することはできます。"
                },
                {
                    "question": "トロッコが壊れている人にランプの破壊カードをつかうことはできますか？",
                    "answer": "別の種類の道具に対しては破壊を重ねることができます。全ての道具が修理されるまでそのプレイヤーは掘ることができません。"
                },
                {
                    "question": "破壊/修理カードにランプとトロッコなど2つのマークが描かれているものは同時に破壊/修理できるのですか？",
                    "answer": "2つのマークが描かれていてもいずれか一方の破壊/修理しかできません。"
                },
                {
                    "question": "ゴールカードに到達した際にいままでつくった道と繋がっていなかったらどうしますか？",
                    "answer": "通路カードはそのままです。戻したり捨て札にしたりはしません。"
                },
            ],
    ...
    },
    {
        ...
        details:{
            gameStory:"宝石の煌きは宝石を集め、カードを購入してポイントを稼ぐ拡大再生産ゲームです。カードは必要な分の宝石を支払うことで買うことができ、買ったカードによって異なる得点と宝石の「ボーナス」がつきます。宝石のボーナスは以降カードを買う際に支払う宝石を少なくすることができるため、宝石の種類や買う順番を工夫することでより早くゲームを展開することができます。効率よく宝石を集めてカードを購入して誰よりも早く得点を稼ぎましょう。",
            basicInfo:{
                refPrice:"5000円",
                numPlayers:"2~4人",
                playTime:"30分",
        ...
        qAndA:[
                {
                    "question": "ゲームの準備で使わなかった貴族タイルや宝石はどうしますか？",
                    "answer": "今回のゲームでは使わないので箱にしまいます。"
                },
                {
                    "question": "ゲームの準備で人数によって宝石の個数が変わりますが、金貨は変わりますか？",
                    "answer": "金貨は人数に関わらず5枚です。"
                },
                {
                    "question": "ダイヤマーカーの役割は最初の親を示すだけですか？",
                    "answer": "だれかが勝利点15点を獲得した際に全員が同じ手番の数を行ったかの確認に用います。"
                },
                {
                    "question": "宝石をとるさいに異なる2種類だけをとることはできますか？",
                    "answer": "宝石がある場合は必ず異なる3種類を3枚とる必要があります。3種類がない場合にのみ2種をとることができます。"
                },
                {
                    "question": "ゲームの終了時、勝利点が同点の場合はどうなりますか？",
                    "answer": "発展カードの枚数が少ない方が勝ちです。それも同数の場合はひきわけです。"
                },
    ...
    },
    {
        ...
        details:{
            gameStory:"ウボンゴは制限時間内にパズルボードにタイルをそろえる王道パズルゲームです。プレイヤーはサイコロをふってでた目によって今回使うタイルがきまります。その後それらのタイルをすばやくボードに配置します。できたらウボンゴ！と宣言して報酬をもらうことができます。1位,2位の人は追加の報酬があるのでいち早くパズルを完成させましょう。",
            basicInfo:{
                refPrice:"4400円",
                numPlayers:"1~4人",
                playTime:"25分",
